...
easy plug-n-play autoscaling infra.
...
I want to briefly explain what I did in this blog post, and dive deeper into
the different parts of the solution in follow up posts.

> Let me know on [Bluesky 🦋](https://bsky.app/profile/drornir.dev)
> or [Email 📧](mailto:me@drornir.dev) or a
> [GitHub issue 🐱](https://github.com/drornir/website/issues) on this repo
> if you'd like me
...
interesting to people who already know they need this custom stack. Feel free
to skip ahead to the next header where I start explaining my solution.
