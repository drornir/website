# My Blog in Astro with eliancodes/brutal theme

## Development

### Dev Log

The project was inisitialized like this:

```bash
% npm create astro@latest -- --template eliancodes/brutal

> npx
> create-astro --template eliancodes/brutal
 ...
 astro   Launch sequence initiated.
   ...
   dir   Where should we create your new project?
         ./brutal
      ◼  tmpl Using eliancodes/brutal as project template
  ...
  next   Liftoff confirmed. Explore your project!
         ...
         Enter your project directory using cd ./brutal
...
## Below is the original README from the theme
